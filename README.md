...
This Jekyll website, **[hp-template (Staging)](https://template.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
